...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        decryptedText = uncypherVigenere(encryptedText, key);
        System.out.println(decryptedText);
    ...
    public static String cypherVigenere(String encryptedText, String key) {
        String result = "";
        int posH;
        int posV;
    ...
    public static String uncypherVigenere(final String text, final String key) {
        String result = "";
        int posH = 0;
        int posV = 0;
    ...
    public static String genKey(final String alphabetVigenere, final int keyLength) {
        String newKey = "";
        int counter = 0;
        char c = 0;
...
//      string = string.replace(textOld, textNew);
    ...
    public static String glyphSubstitute(String number) {
        String result = "";
    ...
    public static boolean isCoorectAutoMNumber(String number) {
